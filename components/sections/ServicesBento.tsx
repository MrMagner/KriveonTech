        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className={`p-8 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 hover:border-primary/50 flex flex-col justify-between transition-colors ${service.colSpan}`}
            >
              <div>
